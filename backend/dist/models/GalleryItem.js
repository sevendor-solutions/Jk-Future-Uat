...
let GalleryItem = GalleryItem_1 = class GalleryItem extends sequelize_typescript_1.Model {
    static async generateSequentialId(instance) {
        if (!instance.id || instance.id.startsWith('g_')) {
            const all = await GalleryItem_1.findAll();
            let nextNum = 1;
            all.forEach(item => {
...
__decorate([
    ...
    __metadata("design:type", String)
], GalleryItem.prototype, "thumbnail", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({
        type: sequelize_typescript_1.DataType.STRING,
        allowNull: true
    ...
    __metadata("design:type", String)
], GalleryItem.prototype, "projectAssociation", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({
        type: sequelize_typescript_1.DataType.STRING,
        allowNull: false
    ...
    __metadata("design:type", String)
], GalleryItem.prototype, "date", void 0);
__decorate([
...
], GalleryItem, "generateSequentialId", null);
exports.GalleryItem = GalleryItem = GalleryItem_1 = __decorate([
    (0, sequelize_typescript_1.Table)({ tableName: "gallery_items" })
], GalleryItem);
